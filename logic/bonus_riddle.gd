...
var riddles = [
	...
	"Question: How can you make a sandwitch much tastier?\n\nAnswer: Ask witch to add some sand to it.",
	"Question: What is tall, And has a small friend, They're in the same grade, They go on adventures, They help they're countrie day by day, But one small friend choked on American Chop Suey. But survived, and still they are alive.\n\nAnswer: Freak the Mighty!",
	"Question: I drive men mad For love of me, Easily beaten, Never free.\n\nAnswer: gold",
	"Question: I am everywhere you go, I hear everything you say, I see all that you see, But, i am unseen.  What am I?\n\nAnswer: Air",
	...
	"Question: Imagine you are in a box, it is sealed and made out of metal. there is no locks windows or small holes in the box. u brought nothing and it is hardly able to get out. but how can you get out?\n\nAnswer: Stop imaginating",
	...
	"Question: If thers a penney,nickel,dime,and a quaartheron top of a roof and the penney,nickel,and the dime jups of a billding and quarther does not?\n\nAnswer: because he has more cents",
	"Question: I run through hills;  I veer around mountains.  I leap over rivers  and crawl through the forests.  Step out your door to find me.  What am I?\n\nAnswer: The road.",
	"Question: What did the leg say to the foot??\n\nAnswer: Joint me and we will go places!!",
	"Question: Which does not belong in this group: Apple, Grape, Banana, Cherry, Pear.\n\nAnswer: The Banana. It's the only one that needs peeling before eating.",
	...
	"Question: I await the fall of night To give my victims a painful bite But I hide when light's avast The darknesses clutches hold me fast  What am I?\n\nAnswer: A vampire",
	"Question: Why is life so much like a shower?\n\nAnswer: Because one wrong turn and your in hot water",
	"Question: What has four legs, a tail and goes \"OOM OOM?\"\n\nAnswer: A cow walking backwards.",
	"Question: There is a man  stood on top of a mountain  frozen holding a peice of straw.  How did he get there?\n\nAnswer: He was with his friend in a hotair balloon when they were about to hit a mountin so they took of there clothes to make it lighter so they would go higher but it wasnt working so they drew straws and who ever had the shortest straw would have to jump out so he was the one who picked the shortest straw.",
	"Question: You have 100 coins but none of them are nickels but all 100 of the coins total $5.00. What are those 100 coins?\n\nAnswer: 75 pennies = 0.75 15 dimes = 1.50 9 quarters = 2.25 1 halfdollar = 0.50 90 pennies $0.90 6 dimes $0.60 1 half dollar coin $0.50 3 dollar coins $3.00 Can Be More Ways",
	"Question: First thinl of the person who lives in disguise, who deals in secrets and tells naught but lies. Next, tell me what's always the last thing to mend, The middle of middle and end of the end? And finaly give me the sound often heard, during the search for a hard-to-find word. Now string them together, and answer me this, Which creature would you be unwilling to kiss?\n\nAnswer: A Spider",
	"Question: When do elephants have 8 feet?\n\nAnswer: When thaey are two.",
	"Question: John is the father of Peter. Peter is the son of John. John is the __________ of Peter's father. Fill in the blank.\n\nAnswer: John is the 'name' of Peter's father.",
	"Question: There was a boy who invited a friend over to play. the mum said \"im going to go to the shops now\". so she did. the kids played footy inside. when mum got home and said \"you have been playing football haven't you?\" How did she know??\n\nAnswer: The glass was on the outside",
	"Question: There is a room with nothing in it. It is 20 foot from the floor to the ceiling and there is a man hung from the ceiling all there is, is a puddle of water underneath him how did he manage to hang himself?\n\nAnswer: The puddle was a block of ice so he climbed up it hung himself and the ice melted.",
	"Question: Are you taller when you wake up, and troughout the day, or when you go to bed?\n\nAnswer: You are taller when you wake up and throughout the day. This is caused by the expanding of your back when you wake up.When you go to sleep, your back relaxes, causeing it to get shorter. Just by a bit, though!",
	"Question: How can you buy 4 suits for a dollar?\n\nAnswer: Buy a deck of cards.",
	"Question: A person gave birth to a pair of twins. Both were girls.the girls gave birth to quadriplets. two were boys and two were girls. the girls would give birth to how many kids.How may kids did they both give births to?\n\nAnswer: 8",
	"Question: What is black, white and red all over?\n\nAnswer: A newspaper",
	"Question: When do you start at red and end at green\n\nAnswer: When you're in a race",
	"Question: The farmer went to town on sunday stay for three days and came back on sunday.How is that possible?\n\nAnswer: The horses name was Sunday",
	"Question: How Do You Live When You Died??\n\nAnswer: You Have CHRIST In Your Heart!!!!",
	...
	"Question: I am an object. Use fractions to figure this out. If you take away the whole of me, i get bigger. What am I?\n\nAnswer: A donut",
	"Question: Before Mount Everest was discovered, what was the highest mountain on Earth?\n\nAnswer: MT.EVEREST",
	"Question: What is special about these 2 groups? 1. T N L K A Z Y 2. R Q O J G D S I do not know the answer, please help.\n\nAnswer: I do not know, please help!!!!",
	"Question: A train runs exactly on the border of Canada and the United States. The train crashes. Where do they bury the survivors?\n\nAnswer: They don't bury survivors they bury non'survivors!",
	"Question: I am here although im not, u can hear me through the trees that rot, i am clear, i am strong, though some days i can really pong!\n\nAnswer: Air",
	"Question: How can you say rabbit without the letter R?\n\nAnswer: bunny",
	"Question: You want to send a valuable object to a friend. You have a box which is more than large enough to contain the object. You have several locks with keys. The box has a locking ring which is more than large enough to have a lock attached. But your friend does not have the key to any lock that you have. How do you do it? Note that you cannot send a key in an unlocked box, since it might be copied.\n\nAnswer: Attach a lock to the ring. Send it to her. She attaches her own lock and sends it back. You remove your lock and send it back to her. She removes her lock.",
	"Question: What goes up a chimney when down, but can't go down the chimney when up?\n\nAnswer: An umbrella",
	"Question: What is at the beginning of today and the start of tommorrow, but not in the same place by night\n\nAnswer: The letter T",
	"Question: You go out with $300 and somebody took it, you told them too 6 days later you go get it back from them. Who took the money?\n\nAnswer: A Banker",
	"Question: If you think you got it answer this i an the and and thee i am ever thing  what am i?\n\nAnswer: god",
	"Question: What accur once in a minute ,twice in a moment but never in a thosand years?\n\nAnswer: The letter M",
	"Question: This is where i keep my sweets, try to guess. It holds my coat and the old books,To find out this riddle i might say, i keep it in here everyday. The books might be old, but not the sweets. You might find this thing in high school,keep looking keep looking and you might drool. Hard to find? i wont tell, the riddle isent over so keep on looking.The sweets are in here with steaming glaze, the books are soggy, and so is my coat. As you can see the riddle is long, so its over finished thats all. What is it?\n\nAnswer: My locker in school.",
	"Question: Who can type an email without a keyboard?\n\nAnswer: Chuck Norris",
	"Question: David's mom had four kids. The first one was a boy named Jimmy. The second one was a girl named Sammy. The third was a boy named Chris. The fourth one was a boy. What was his name?\n\nAnswer: David",
	"Question: I have no head i hve a body what am i tell the name\n\nAnswer: jasim",
	"Question: Your in a race and you pass the person in 2nd place,What place are you in?\n\nAnswer: You are in 2nd place.=)",
	"Question: I have four legs and covered with spots but I can also swim in the water. And stay on land. What am I?\n\nAnswer: Frog",
	"Question: Lily had a party and only invited 10 people who like each other.Lily asked everyone to sit in a circle nexted to who they liked. So it was Lily liked John, John liked Natalie, Natalie liked Ethan, Ethan liked Melissa, Melissa liked Daniel, Dan liked Venissa, Venessa liked Phil, Phil like Samantha, samantha likes Garrett, and garrett liked Lara. Whats wrong wit this circle of love.\n\nAnswer: its not a complete circle. nobody likes Lily :)",
	"Question: Is it possible to make up a sentence that ends with the letter I\n\nAnswer: Is it possible to make up a sentence that ends with that letter I The Question is the answer",
	"Question: You are stranded in a cabin with one match. There are an oil lamp, a fireplace and a furnace. which do you light first.\n\nAnswer: The match",
	"Question: I'm the beginning of eternity and the end of space and time. What am I?\n\nAnswer: E!",
	"Question: Yo Momma is so fat she fell and ate a red book. How is that so?\n\nAnswer: Driving Drunk Kills",
	"Question: What has no eyes but can see?\n\nAnswer: I don't know I thought you did. Ha Ha.",
	"Question: There was a plane crash yesterday and every single person died and two people survived. How could this happen?\n\nAnswer: The two people were married.",
	"Question: What object has keys that open no locks, space but no room, and you can enter but not go in?\n\nAnswer: A computer keyboard.",
	"Question: I can move around,  But my space is restricted Direct me, And I will go where you surf. I have the name of an animal, But I am mechanical. Who or what am I ?\n\nAnswer: A computer mouse",
	"Question: How can you give someone $63 using six bills, without using any one dollar bills?\n\nAnswer: 1 - $50 bill, 1 - $5 bill , 4 - $2 bills",
	"Question: My mother likes coffee but doesnt like tea.\n\nAnswer: my mother likes coffee but doesnt like \"t\" Example:my mother likes baseball but doesnt like tennis which ever word that begins with a \"T\" or has a \"T\" in it my mother does not like.",
	...
	"Question: A man is in a room and the door is locked so he can't get out. He has with him a piano, a calendar, and a bed. How does he eat, drink, and get out?\n\nAnswer: He uses the dates from the calendar to eat, the springs from the bed to drink and the keys from the piano to get out.",
	...
	"Question: A man builds a house with all sides facing south. A bear passes by outside what color is the bear?\n\nAnswer: White. It was a polar bear because the man was at the north pole.",
	"Question: I turn polar bears white  and I will make you cry.  I make guys have to pee  and girls comb their hair.  I make celebrities look stupid  and normal people look like celebrities.  I turn pancakes brown  and make your champane bubble.  If you sqeeze me, I'll pop.  If you look at me, you'll pop\n\nAnswer: honestly the first thing i thought was life but i now believe that this is one of those riddles that has no answer and is made buy a person that is pestered for a riddle every day and got annoyed so they made a riddle that doesnt have an answer to keep that person occupied while they sat there and laughed a little inside.and if it does have an answer im sure someone would have found it by now!",
	"Question: Jacks mum has four children one is called north,the 2nd east,the 3rd south but what is the 4th?\n\nAnswer: The answer is Jack",
...
#"Question: I have a mouth but I do not eat? I have a bed but I do not sleep? What am I ?\n\nAnswer: A river",
#"Question: What do michael jackson and santa have in common\n\nAnswer: They both empty thier sacks in children's bedrooms",
#"Question: You can never say no to this question, but its hard for you to see, it's easy to answer and with this you became to be. What is the question?\n\nAnswer: Were you born?",
#"Question: Is an old hundred dollar bill better than a new one?\n\nAnswer: Well, it's worth 99 more dollars.",
#"Question: There were 7 monkeys. 1 monkey had 1 banana. The other monkeys wanted that banana. When the other monkeys were about to try and get the banana, the one monkey, with the 1 banana was gone! What happened?\n\nAnswer: When the other monkeys wern't looking, the monkey with the banana, ate the banana,and ran away, when the other monkeys wernt looking.",
#"Question: If ya mum was a super hero whu wud she save u or da world?\n\nAnswer: da world of course ur so dum u think she is just save u ur not worth it",
#"Question: Why did the chicken cross the road.\n\nAnswer: To get to the other side",
#"Question: I'M Alive.................wait what?\n\nAnswer: Where am I?",
